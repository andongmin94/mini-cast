...
foreach ($file in $files) {
  ...
  foreach ($name in @('open','save','affinePreserved','undoRedo','editorUndo','documentIsolation','quitProtected','windowControlsProtected','noOp','cancel','staleRevision','controllerReload','senderRejected')) {
