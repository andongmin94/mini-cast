...
if (-not $payload.diagnostics.textEditingTools.save -or -not $payload.diagnostics.textEditingTools.documentIsolation) { throw 'Existing-text editing isolation was not verified.' }
